...
@Configuration
@EntityScan(basePackageClasses = {QuestionJpaEntity.class, SurveyJpaEntity.class, SubmissionJpaEntity.class})
@EnableJpaRepositories(basePackageClasses = {QuestionJpaRepository.class, SurveyJpaRepository.class, SubmissionJpaRepository.class})
